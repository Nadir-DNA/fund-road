...
export const useResourceDataLoader = (
  ...
  // Effect to load resource data on mount
  useEffect(() => {
    const loadResourceData = async () => {
      setIsLoading(true);
      try {
        console.log(`Loading data for: stepId=${stepId}, substep=${substepTitle}, type=${resourceType}`);
    ...
    // Execute loading and process the result
  ...
  }, [stepId, substepTitle, resourceType, toast, onDataLoaded, session, fetchSession, navigate]);
