...
export const resourceComponentsMap: Record<string, React.LazyExoticComponent<any>> = {
  ...
  // Temporary fallback until MVPSelector component is created
  "MVPSelector.tsx": lazy(() => import("./resources/PersonaBuilder")), // Temporary placeholder
  ...
  "CapTable.tsx": lazy(() => import("./resources/CapTableEditor")), // Changed to point to CapTableEditor
